...
New-ADGroup $O365Group.DisplayName -SamAccountName $O365GroupSamAcc -Path "OUPathOfChoosing" -GroupScope Universal -GroupCategory Distribution -DisplayName $O365Group.DisplayName -OtherAttributes @{'mail'=$O365Group.PrimarySmtpAddress}
